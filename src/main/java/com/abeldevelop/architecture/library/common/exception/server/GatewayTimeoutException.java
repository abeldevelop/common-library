 ...
 * @since 1.0.0
 */
public class GatewayTimeoutException extends AbelDevelopException {
	 ...
	 */
	public GatewayTimeoutException(String message, List<Object> arguments) {
	 ...
	 * @param cause the cause
	 */
	public GatewayTimeoutException(String message, List<Object> arguments, Throwable cause) {
