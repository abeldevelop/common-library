...
/**
 * The Class UriTooLongException.
 * 
 * @since 1.0.0
 */
public class UriTooLongException extends AbelDevelopException {
	...
	/**
	 * Instantiates a new uri too long exception.
	 *
	 ...
	 */
	public UriTooLongException(String message, List<Object> arguments) {
	 ...
	 * @param cause the cause
	 */
	public UriTooLongException(String message, List<Object> arguments, Throwable cause) {
