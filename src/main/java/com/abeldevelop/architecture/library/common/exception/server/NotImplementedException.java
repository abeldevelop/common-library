 ...
 * @since 1.0.0
 */
public class NotImplementedException extends AbelDevelopException {
	 ...
	 */
	public NotImplementedException(String message, List<Object> arguments) {
	 ...
	 * @param cause the cause
	 */
	public NotImplementedException(String message, List<Object> arguments, Throwable cause) {
