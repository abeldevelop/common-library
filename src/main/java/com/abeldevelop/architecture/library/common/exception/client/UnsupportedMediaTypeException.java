 ...
 * @since 1.0.0
 */
public class UnsupportedMediaTypeException extends AbelDevelopException {
	 ...
	 * @param cause the cause
	 */
	public UnsupportedMediaTypeException(String message, List<Object> arguments, Throwable cause) {
