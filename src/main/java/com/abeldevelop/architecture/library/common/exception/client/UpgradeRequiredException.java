...
/**
 * The Class UpgradeRequiredException.
 * 
 * @since 1.0.0
 */
public class UpgradeRequiredException extends AbelDevelopException {
	...
	/**
	 * Instantiates a new upgrade required exception.
	 *
	 ...
	 */
	public UpgradeRequiredException(String message, List<Object> arguments) {
	 ...
	 * @param cause the cause
	 */
	public UpgradeRequiredException(String message, List<Object> arguments, Throwable cause) {
