 ...
 * @since 1.0.0
 */
public class PaymentRequiredException extends AbelDevelopException {
	 ...
	 */
	public PaymentRequiredException(String message, List<Object> arguments) {
	 ...
	 * @param cause the cause
	 */
	public PaymentRequiredException(String message, List<Object> arguments, Throwable cause) {
