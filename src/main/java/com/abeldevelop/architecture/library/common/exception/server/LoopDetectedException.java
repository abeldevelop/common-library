...
/**
 * The Class LoopDetectedException.
 * 
 * @since 1.0.0
 */
public class LoopDetectedException extends AbelDevelopException {
	...
	/**
	 * Instantiates a new loop detected exception.
	 *
	 ...
	 */
	public LoopDetectedException(String message, List<Object> arguments) {
	 ...
	 * @param cause the cause
	 */
	public LoopDetectedException(String message, List<Object> arguments, Throwable cause) {
