 ...
 * @since 1.0.0
 */
public class UnauthorizedException extends AbelDevelopException {
	 ...
	 */
	public UnauthorizedException(String message, List<Object> arguments) {
	 ...
	 * @param cause the cause
	 */
	public UnauthorizedException(String message, List<Object> arguments, Throwable cause) {
