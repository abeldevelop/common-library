 ...
 * @since 1.0.0
 */
public class RequestTimeoutException extends AbelDevelopException {
	 ...
	 */
	public RequestTimeoutException(String message, List<Object> arguments) {
	 ...
	 * @param cause the cause
	 */
	public RequestTimeoutException(String message, List<Object> arguments, Throwable cause) {
