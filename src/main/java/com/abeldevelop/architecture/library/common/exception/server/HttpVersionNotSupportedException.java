 ...
 * @since 1.0.0
 */
public class HttpVersionNotSupportedException extends AbelDevelopException {
	 ...
	 */
	public HttpVersionNotSupportedException(String message, List<Object> arguments) {
	 ...
	 * @param cause the cause
	 */
	public HttpVersionNotSupportedException(String message, List<Object> arguments, Throwable cause) {
