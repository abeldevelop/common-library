...
/**
 * The Class PreconditionRequiredException.
 * 
 * @since 1.0.0
 */
public class PreconditionRequiredException extends AbelDevelopException {
	...
	/**
	 * Instantiates a new precondition required exception.
	 *
	 ...
	 */
	public PreconditionRequiredException(String message, List<Object> arguments) {
	 ...
	 * @param cause the cause
	 */
	public PreconditionRequiredException(String message, List<Object> arguments, Throwable cause) {
